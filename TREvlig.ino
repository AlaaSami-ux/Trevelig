// DALIAS program, IN1060, 2019, som kontrollerer TREvlig
...
#define PIN_TRE 5 // hvilket pin som går til lysene

Adafruit_NeoPixel strip(NUMPIXELS, PIN_TRE, NEO_GRB + NEO_KHZ800);

#include "HX711.h" // for vektsensor
#define calibration_factor 781.86 //Dette fikk vi av å bruke SparkFun_HX711_Calibration sketch 
...
#define TID_MELLOM_PAAMINNELSER 600000 // Tiden mellom de tre påminnelser (600000 ms er 10 minutter)//test med 60000 (= 1minutt)
#define INTERVALL_UTEN_AT_NOE_SKJER 5400000 // Tiden (5400000 milisekunder=1,5 timer) etter det systemet notifiserer brukeren at hun ikke har beveget seg //test med 300000 (5 minutter)
#define MANGE_TIMER 28800000 // 28800000 ms er 8 timer: etter det uten røring skal systemet gå i dvale // test med 1800000 (halvtime)
#define VENTETID_VISE_TRE 400 // hvor lenge skal TREVlig vise treet når den våkner
#define VENTETID_FOR_DRIKKING 400 // hvor lenge skal den vise at man har drukket (tilbakemelding)

// konstanter som handler om vekt
#define UVESENTLIG_VEKT_FORSKJELL 20 // for å stabilisere vektmålinger
#define VEKT_FORSKJELL 40 // hvor lite forskjell i vekt på vann TREvlig er sensitiv til
...
int farge3[5];
int gang=0; // teller hvor mange ganger etter 7 har man beveget seg
...
void setup() {
  ...
  // koden her er bare for å vise at alle piksler kan addresseres 
